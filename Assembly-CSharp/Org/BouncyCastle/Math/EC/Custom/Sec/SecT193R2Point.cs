...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
	...
	{
		// Token: 0x06001F06 RID: 7942 RVA: 0x000AABA1 File Offset: 0x000A8DA1
		public SecT193R2Point(ECCurve curve, ECFieldElement x, ECFieldElement y) : this(curve, x, y, false)
		{
		}

		// Token: 0x06001F07 RID: 7943 RVA: 0x000A5578 File Offset: 0x000A3778
		public SecT193R2Point(ECCurve curve, ECFieldElement x, ECFieldElement y, bool withCompression) : base(curve, x, y, withCompression)
		{
			if (x == null != (y == null))
			{
		...
		// Token: 0x06001F08 RID: 7944 RVA: 0x00097090 File Offset: 0x00095290
		internal SecT193R2Point(ECCurve curve, ECFieldElement x, ECFieldElement y, ECFieldElement[] zs, bool withCompression) : base(curve, x, y, zs, withCompression)
		{
		}

		// Token: 0x06001F09 RID: 7945 RVA: 0x000AABAD File Offset: 0x000A8DAD
		protected override ECPoint Detach()
		{
			return new SecT193R2Point(null, this.AffineXCoord, this.AffineYCoord);
		}

		// Token: 0x1700031F RID: 799
		// (get) Token: 0x06001F0A RID: 7946 RVA: 0x000AABC4 File Offset: 0x000A8DC4
		...
		// (get) Token: 0x06001F0B RID: 7947 RVA: 0x000AAC1C File Offset: 0x000A8E1C
		...
		// Token: 0x06001F0C RID: 7948 RVA: 0x000AAC50 File Offset: 0x000A8E50
			...
			else
			{
				...
				if (!ecfieldElement9.IsZero)
				{
					...
					if (rawXCoord.IsZero)
					{
						...
						{
							return new SecT193R2Point(curve, ecfieldElement11, curve.B.Sqrt(), base.IsCompressed);
						}
					...
					return new SecT193R2Point(curve, ecfieldElement11, y, new ECFieldElement[]
					{
						ecfieldElement12
					}, base.IsCompressed);
				}
		...
		// Token: 0x06001F0D RID: 7949 RVA: 0x000AAEB8 File Offset: 0x000A90B8
		public override ECPoint Twice()
		{
			...
			return new SecT193R2Point(curve, ecfieldElement4, y, new ECFieldElement[]
			{
				ecfieldElement5
			}, base.IsCompressed);
		}

		// Token: 0x06001F0E RID: 7950 RVA: 0x000AAFD8 File Offset: 0x000A91D8
		public override ECPoint TwicePlus(ECPoint b)
		{
			...
			else
			{
				...
				return new SecT193R2Point(curve, x2, y, new ECFieldElement[]
				{
					ecfieldElement8
				}, base.IsCompressed);
			}
		...
		// Token: 0x06001F0F RID: 7951 RVA: 0x000AB180 File Offset: 0x000A9380
		public override ECPoint Negate()
		{
			...
			ECFieldElement rawYCoord = base.RawYCoord;
			ECFieldElement ecfieldElement = base.RawZCoords[0];
			return new SecT193R2Point(this.Curve, rawXCoord, rawYCoord.Add(ecfieldElement), new ECFieldElement[]
			{
				ecfieldElement
			}, base.IsCompressed);
		}
