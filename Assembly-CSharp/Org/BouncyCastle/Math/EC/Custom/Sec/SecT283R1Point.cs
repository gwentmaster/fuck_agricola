...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
	...
	{
		// Token: 0x0600201E RID: 8222 RVA: 0x000AEF56 File Offset: 0x000AD156
		public SecT283R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y) : this(curve, x, y, false)
		{
		}

		// Token: 0x0600201F RID: 8223 RVA: 0x000A5578 File Offset: 0x000A3778
		public SecT283R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y, bool withCompression) : base(curve, x, y, withCompression)
		{
			if (x == null != (y == null))
			{
		...
		// Token: 0x06002020 RID: 8224 RVA: 0x00097090 File Offset: 0x00095290
		internal SecT283R1Point(ECCurve curve, ECFieldElement x, ECFieldElement y, ECFieldElement[] zs, bool withCompression) : base(curve, x, y, zs, withCompression)
		{
		}

		// Token: 0x06002021 RID: 8225 RVA: 0x000AEF62 File Offset: 0x000AD162
		protected override ECPoint Detach()
		{
			return new SecT283R1Point(null, this.AffineXCoord, this.AffineYCoord);
		}

		// Token: 0x1700036C RID: 876
		// (get) Token: 0x06002022 RID: 8226 RVA: 0x000AEF78 File Offset: 0x000AD178
		...
		// (get) Token: 0x06002023 RID: 8227 RVA: 0x000AEFD0 File Offset: 0x000AD1D0
		...
		// Token: 0x06002024 RID: 8228 RVA: 0x000AF004 File Offset: 0x000AD204
			...
			else
			{
				...
				if (!ecfieldElement9.IsZero)
				{
					...
					if (rawXCoord.IsZero)
					{
						...
						{
							return new SecT283R1Point(curve, ecfieldElement11, curve.B.Sqrt(), base.IsCompressed);
						}
					...
					return new SecT283R1Point(curve, ecfieldElement11, y, new ECFieldElement[]
					{
						ecfieldElement12
					}, base.IsCompressed);
				}
		...
		// Token: 0x06002025 RID: 8229 RVA: 0x000AF268 File Offset: 0x000AD468
		public override ECPoint Twice()
		{
			...
			return new SecT283R1Point(curve, ecfieldElement4, y, new ECFieldElement[]
			{
				ecfieldElement5
			}, base.IsCompressed);
		}

		// Token: 0x06002026 RID: 8230 RVA: 0x000AF36C File Offset: 0x000AD56C
		public override ECPoint TwicePlus(ECPoint b)
		{
			...
			else
			{
				...
				return new SecT283R1Point(curve, x3, y, new ECFieldElement[]
				{
					ecfieldElement7
				}, base.IsCompressed);
			}
		...
		// Token: 0x06002027 RID: 8231 RVA: 0x000AF500 File Offset: 0x000AD700
		public override ECPoint Negate()
		{
			...
			ECFieldElement rawYCoord = base.RawYCoord;
			ECFieldElement ecfieldElement = base.RawZCoords[0];
			return new SecT283R1Point(this.Curve, rawXCoord, rawYCoord.Add(ecfieldElement), new ECFieldElement[]
			{
				ecfieldElement
			}, base.IsCompressed);
		}
